...
# in this version of this component, i made the keys of the dictionary and values of the sets matching. thus they are easier to map out.
...
reserved = {"Neville Longbottom", "Luna Lovegood", "Ginny Weasley"} 

#matching opperation will be applied for thsi question here

#Which one of these would you like  in a friend would you like?
...
#What trait would you love in your friend
...
#What is a trait you cannot tolerate in a person
...
#What’s an annoying trate u don’t mind tolerating.
#REUSING THE SETS ABOVE

#Would you rather have a friend who is very…
